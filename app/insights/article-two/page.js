    ...
    <main className="py-7 lg:pb-20">
      ...
      <section className="pt-8 text-primary">
        <Animate className="mx-auto px-5 max-w-[1014px]">
          ...
          <Animate as="h2" className="text-[32px] lg:text-[40px] leading-[1.2] mb-5 lg:mb-8 ff-2">The power of conscious Namaaz to heal the mind, body and spirit and power of Quranic recitations and vibrations</Animate>
