        ...
        <>
            <div className='-mx-2 lg:-mx-7 flex flex-wrap -mt-14 lg:items-center'>
                <Animate className='px-2 w-full lg:w-2/3 lg:px-7 mt-14'>
                    ...
                    <p className='lg:text-lg leading-[1.5]'>The power of group meditation is way bigger than we can actually think. The vary reason a lot of duas (during Namaz and after Namaz) are asked to Allah in big groups of people at the mosques is to have a super amplified impact of the Dua. The power of pouring the same intent at the same time in groups is beyond imaginable. If you are seeking some desire to manifest that is very important to you like sending healing prayers for a loved one’s recovery or have a very important job or business deal to fall into place or desiring to marry the perfect partner, this program is for you. </p>
                </Animate>
