    ...
    <section className='pt-5 lg:pt-14 lg:pb-5 text-primary'>
        <Container>
            <div className='max-w-[1180px] mx-auto lg:text-center'>
                ...
                <h2 className='h2 leading-[1.2] py-7 lg:py-14 text-center ff-2'>Accept a three-day challenge for offering Tahajjud Namaaz with us and witness yor life changes for the best</h2>
            </div>
        </Container>
    </section>    
  )
